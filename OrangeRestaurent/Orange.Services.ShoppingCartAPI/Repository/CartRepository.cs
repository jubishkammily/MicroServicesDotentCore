...
namespace Orange.Services.ShoppingCartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<CartDto> CreateUpdateCart(CartDto cartDto)
        {
            ...
            //check if product exists in database, if not create it!   (in product table) 
            ...
            if (cartHeaderFromDb == null)
            {
                ...
                cart.CartDetails.FirstOrDefault().Product = null;   // this is done in order to avoid duplicate addition of product by entiti core.
                                                                    // Since the product object is given in teh CarDetails class as foreign key
                                                                    // the product has been added above so no noeed to add again    
            ...
            else
            {
                ...
                // AsNoTracking is added because entity fw is already tracking the db.CartDetails so that cannot be updated here .
                // So to stop trackin and update the cartDetails we need to add thiss
