...
using Orange.Services.Identity.MainModule.Account;
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // these are the steps for security  it will work without this but not secure
                    if(context != null)
                    {
                        return Redirect(model.ReturnUrl);
                    }

                    // to check if this is not a fishy or suspecious url
